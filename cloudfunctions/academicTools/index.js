...
const DEFAULT_TOOLS = [
  ...
  { id: 'specialIssue',name: '特刊策划', desc: 'AI策划特刊话题、推荐客编', icon: 'lightbulb', iconEmoji: '💡', color: 'blue', category: 'ext',  order: 6, comingSoon: false, isPublished: true, pagePath: '/pages/specialIssue/specialIssue', isTaskType: false },
