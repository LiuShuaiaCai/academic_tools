...
const DEFAULT_TOOLS = [
  ...
  { id: 'citation',    name: '文献引用', desc: 'GB/T 7714、APA格式化', icon: 'quote-right',  iconEmoji: '📚', color: 'purple', category: 'ext',  order: 4, comingSoon: false, isPublished: true, pagePath: '/pages/citation/citation', isTaskType: false },
  { id: 'specialIssue',name: '特刊策划', desc: 'AI策划特刊话题、推荐客编', icon: 'lightbulb', iconEmoji: '💡', color: 'teal', category: 'ext',  order: 5, comingSoon: false, isPublished: true, pagePath: '/pages/specialIssue/specialIssue', isTaskType: true },
  { id: 'archive',     name: '资料归档', desc: '统一管理附件文件',    icon: 'folder-open',   iconEmoji: '📁', color: 'orange', category: 'ext', order: 6, comingSoon: false, isPublished: true, pagePath: '/pages/archive/archive', isTaskType: false },
  { id: 'journal',     name: '期刊分析', desc: '查期刊、看指标、智能选刊', icon: 'search', iconEmoji: '🔍', color: 'purple', category: 'ext', order: 7, comingSoon: false,  isPublished: false, pagePath: '/pages/journal/search/search', isTaskType: false },
...
// 所有集合
const COLLECTIONS = ['tools', 'user_tools', 'submissions', 'reviews', 'conferences', 'archives', 'archive_categories', 'user_config', 'credits', 'tasks','user_settings','feedbacks','journals','journal_subject','journal_metrics_yearly','journal_warnings'];
