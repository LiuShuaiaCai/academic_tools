// pages/submissions/stats/stats.js
var subConfig = require('../../../utils/submissions-config.js');
...
Page({
  ...
  loadStats: function() {
    var that = this;
    var data = { action: 'submissionStatsDetail' };
    ...
    wx.cloud.callFunction({
      ...
      if (trendData.length > 0) {
        trendChartData = {
          ...
          series: [
            { name: '投稿数', data: trendData.map(function(d) { return d.submitted; }) },
      ...
      var journalStats = (r.journalStats || []).map(function(js, idx) {
        var prev = idx > 0 ? r.journalStats[idx - 1] : null;
        return {
          journal: js.journal,
          year: js.year,
          ...
          pending: js.pending,
          isFirstOfGroup: !prev || prev.journal !== js.journal
        };
      });
